...
if __name__ == '__main__':
    ...
    read_time_file_init("./input_info/sat_gs1_encounter_time.txt", 0) # 0-120
    read_time_file_add("./input_info/sat_gs3_encounter_time.txt", per_gs_visible_times * 1)
    ...
    read_range1_file_add("./input_info/sat_gs1_encounter_range.txt", 0)
    read_range1_file_add("./input_info/sat_gs3_encounter_range.txt", per_gs_visible_times * 1)
