...
if __name__ == '__main__':
    ...
    read_time_file_add("./input_info/sat_gs2_encounter_time.txt", per_gs_visible_times * 1)
    ...
    read_range1_file_add("./input_info/sat_gs2_encounter_range.txt", per_gs_visible_times * 1)
